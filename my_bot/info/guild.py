...
from .config import (
    com_gld, com_own, com_mem, com_rol, com_cat, com_cha, com_tcha, com_vcha,
    com_pcha, com_gcha, com_ncha, com_scha, com_emo, com_shl)
...
class InfoGuildCommands(Cog, name='Commands Info Guild'):
    ...
    @command(name=com_gld.name, help=com_gld.help, ignore_extra=False)
